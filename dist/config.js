...
export async function loadConfig(configPath) {
    ...
    const stateRoot = process.env.OS_AGENTS_HOME ?? path.join(projectRoot, ".os-agents");
    ...
    const baseDirectory = fileConfig.copilot?.baseDirectory ?? path.join(stateRoot, "copilot-home");
    const config = {
        projectRoot,
        stateRoot,
        workspaceRoot,
        ...
        github: {
            ...
            dispatchEventType: fileConfig.github?.dispatchEventType ?? "openspec_orchestrator_handoff",
