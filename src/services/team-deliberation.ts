import type { RunRecord, TeamAgreement, TeamMemberResult, TeamVote } from "../domain/types.js";
import { DEVELOPER_PERSONAS } from "../team/personas.js";

const AGREEMENT_THRESHOLD = 90;

function buildIndividualVote(member: TeamMemberResult): TeamVote {
...
export class TeamDeliberationService {
  public createMemberResults(runs: RunRecord[]): TeamMemberResult[] {
  ...
  public evaluateRoundOne(memberResults: TeamMemberResult[]): TeamAgreement {
  ...
  public deliberateMerge(
    memberResults: TeamMemberResult[],
    round: 2 | 3,
    roundOne: TeamAgreement,
  ): TeamAgreement {
  ...
  public selectBestIndividualFallback(
    memberResults: TeamMemberResult[],
    roundOne: TeamAgreement,
  ): TeamAgreement {
